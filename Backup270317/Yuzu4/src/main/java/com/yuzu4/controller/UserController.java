...
public class UserController {
	...
	public String doRegistraton(@Valid @ModelAttribute(value = "user") User user, BindingResult result, Model model) {
		...
		model.addAttribute("regsuccess", "Registered Successfully. Login using username and password");
	...
	public ModelAndView validateCredentials(@Valid @ModelAttribute(name = "userObject") User user, Model model,
		...
		if (userDAO.validate(user.getName(), user.getPassword())) {
			// Make userloogedIn as True
