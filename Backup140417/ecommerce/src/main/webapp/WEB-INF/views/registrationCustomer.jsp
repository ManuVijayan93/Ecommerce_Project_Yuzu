...
<!-- DC Contact Form Start -->
  <div style="margin-bottom:20px; padding:20px 20px 0; color:#01060c;  border-radius:8px;">
	...
	<div class="container-wrapper">
		<div class="container">
			...
			<form:form action="${url}" method="post" commandName="customer"  class="dc_form_contact_dark frame tbar">
