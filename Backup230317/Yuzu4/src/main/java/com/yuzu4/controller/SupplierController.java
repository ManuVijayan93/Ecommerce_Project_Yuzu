...
public class SupplierController {
	...
	public ModelAndView deleteSupplier(@PathVariable(value = "id") int id, Model model) {
	...
	public ModelAndView editSupplier(@ModelAttribute(value = "editSupplierObj") Supplier supplier, Model model) {
