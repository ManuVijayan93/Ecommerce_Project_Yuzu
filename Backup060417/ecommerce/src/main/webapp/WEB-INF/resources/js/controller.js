var myapp = angular.module("myapp", []).controller(
		...
		function($scope, $http) {
			...
			$scope.addToCart = function(productId) {
				...
				$http.put('http://localhost:8080/ecommerce/cart/add/'+ productId).success(function() {
			...
			$scope.refreshCart = function(cartId) {
				...
				$http.get('http://localhost:8080/ecommerce/cart/getCart/'
			...
			$scope.removeFromCart = function(cartItemId) {
				$http.put(
						'http://localhost:8080/ecommerce/cart/removecartitem/'
			...
			$scope.clearCart = function(cartId) {
				$http.put('http://localhost:8080/ecommerce/cart/removeAllItems/'+ cartId).success(function() {
					$scope.refreshCart($scope.cartId);
				});
			}
